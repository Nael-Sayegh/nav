...
function mastodonShareButtonClick(e)
{
    ...
    const sharingText = "<?php echo addslashes((string) tr($tr0, 'masto_share_title')); ?>" + href + "<?php echo addslashes((string) tr($tr0, 'masto_share_desc')); ?>";
    const mastodonInstance = prompt(sharingText);
    ...
    {
        alert("<?php echo addslashes((string) tr($tr0, 'masto_share_instanceçerror')); ?>");
    }
}
